...
//////// swingjs.api.HTML5Applet interface    
    ...
    proto.repaintNow = function() { Jmol.repaint(this, false) }; 
////////
    ...
    if (!proto._restoreState)
		...
		proto._processGesture = function(touches) {
			return this._appletPanel.processTwoPointGesture$FAAA(touches);
		}

		proto._processEvent = function(type, xym) {
			this._appletPanel.processMouseEvent$I$I$I$I$J(type,xym[0],xym[1],xym[2],System.currentTimeMillis());
		}
    ...
    // JmolObjectInterface 
		...
		//alert("repaint " + Clazz.getStackTrace())
