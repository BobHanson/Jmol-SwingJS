...
//	protected static final String SEQUENCE_INRIA = "CGAUUGCAUCGCAAGU";
	
	protected static final String TARGET_STRUCTURE_1 = "(((((((..)))))))";
	protected static final String TARGET_STRUCTURE_2 = "(((())))(((())))";
	protected static final String TARGET_STRUCTURE_3 = "(.((.((..).)).))";
	protected static final String TARGET_STRUCTURE_4 = "((((((())))(((())(()))))))";
	protected static final String TARGET_STRUCTURE_5 = "(((())))(((())))(((())))(((())))(((())))(((())))";
...
//	protected static final String DEFAULT_STRUCTURE = "..........";
	...
	protected VARNAPanel _vpTarget;
	...
	protected JComboBox<String> _struct = new JComboBox<>();
	protected JLabel _seq1 = new JLabel();
	protected JLabel _structLabel = new JLabel("Structure Cible");
	protected JLabel _seqLabel = new JLabel("Sequence d'ARN");
	protected JButton _switchButton = new JButton("Reset");


	protected Color _backgroundColor = Color.white;

	protected Color _okColor = Color.decode("#E33729");
//	protected Color _koColor = new Color(250,200,200);
	...
	protected void RNAPanelDemoInit() {
		...
		DefaultComboBoxModel<String> cm = new DefaultComboBoxModel<String>(secstr); 
		_struct.setModel(cm);
      ...
      public void actionPerformed(ActionEvent e) {
				...
				setTarget(((JComboBox<String>)e.getSource()).getSelectedItem().toString());
			}
		});
...
// 	}
 	...
 	public static ArrayList<Double> combine(double bonus, ArrayList<Double> part1, ArrayList<Double> part2)
 	{
 		...
 		for(double d1: part1)
 		{
 	 		for(double d2: part2)
 	 		{
 	 			base.add(Double.valueOf(bonus+d1+d2));
 	 		}
 		}
 		return base;
 	}
  ...
  public void onBaseClicked(ModeleBase mb, int id) {
	...
	protected class Temporizer extends Thread{
		String _seq;
