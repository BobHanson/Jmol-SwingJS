...
public class AlignmentDemo extends JFrame{
	...
	protected static final String DEFAULT_SEQUENCE1 =  "CGCGCACGCGA----UAUU----UCGCGUCGCGCAUUUGCGCGUAGCGCG";
	protected static final String DEFAULT_STRUCTURE1 = "(((((.(((((----....----))))).(((((....)))))..)))))";

	protected static final String DEFAULT_SEQUENCE2 =  "CGCGCACGCGSGCGCGUUUGCGCUCGCGU---------------AGCGCG";
	...
	protected JPanel _seq1Panel = new JPanel();
	protected JPanel _seq2Panel = new JPanel();
	protected JPanel _struct1Panel = new JPanel();
	protected JPanel _struct2Panel = new JPanel();
	protected JLabel _info = new JLabel();
	protected JTextField _struct1 = new JTextField(DEFAULT_STRUCTURE1);
	protected JTextField _struct2 = new JTextField(DEFAULT_STRUCTURE2);
	protected JTextField _seq1 = new JTextField(DEFAULT_SEQUENCE1);
	protected JTextField _seq2 = new JTextField(DEFAULT_SEQUENCE2);
	protected JLabel _struct1Label = new JLabel(" Str1:");
	protected JLabel _struct2Label = new JLabel(" Str2:");
	protected JLabel _seq1Label = new JLabel(" Seq1:");
	protected JLabel _seq2Label = new JLabel(" Seq2:");
	protected JButton _goButton = new JButton("Go");

	protected String _str1Backup = "";
	protected String _str2Backup = "";
	protected String _seq1Backup = "";
	protected String _seq2Backup = "";
	protected RNA _RNA = new RNA();

	protected final static String errorOpt = "error";
	...
	protected String cleanStruct(String struct) {
	...
	@SuppressWarnings("unused")
	protected Color getSafeColor(String col, Color def) {
		Color result;
		try {
