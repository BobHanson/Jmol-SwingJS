...
public class SuperpositionDemo extends JFrame implements InterfaceVARNAListener {
	...
	protected static final String DEFAULT_SEQUENCE1 = "CGCGCACGCGAUAUUUCGCGUCGCGCAUUUGCGCGUAGCGCG";
	protected static final String DEFAULT_SEQUENCE2 = "CGCGCACGCGAUAUUUCGCGUCGCGCAUUUGCGCGUAGCGCG";
	...
	protected JLabel _seqLabel = new JLabel(" Seq:");
	protected JButton _goButton = new JButton("Go");
	protected JButton _switchButton = new JButton("Switch");

	protected String _str1Backup = "";
	protected String _str2Backup = "";
	protected RNA _RNA1 = new RNA();
	protected RNA _RNA2 = new RNA();

	protected static String errorOpt = "error";
	...
	protected int _currentDisplay = 1;
