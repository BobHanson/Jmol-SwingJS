...
public class VARNAOnlineDemo extends JApplet {
	...
	protected static final String DEFAULT_SEQUENCE = "CAGCACGACACUAGCAGUCAGUGUCAGACUGCAIACAGCACGACACUAGCAGUCAGUGUCAGACUGCAIACAGCACGACACUAGCAGUCAGUGUCAGACUGCAIA";
	...
	protected JTextField _struct = new JTextField();
	protected JTextField _seq = new JTextField();
	protected JLabel _structLabel = new JLabel(" Str:");
	...
	protected String getParameterValue(String key, String def) {
		String tmp;
	...
	protected void retrieveParametersValues() {
