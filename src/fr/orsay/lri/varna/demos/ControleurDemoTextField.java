...
import fr.orsay.lri.varna.demos.VARNAOnlineDemo;
...
public class ControleurDemoTextField implements CaretListener {
	protected VARNAOnlineDemo _vod;
	protected String _oldSeq, _oldStruct;
	protected Highlighter _hilit;
	protected Highlighter.HighlightPainter _painter;
	protected final Color COLORERROR = Color.RED;
	protected final Color COLORWARNING = Color.ORANGE;
