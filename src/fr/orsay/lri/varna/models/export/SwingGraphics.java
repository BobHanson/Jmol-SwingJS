...
public class SwingGraphics implements VueVARNAGraphics {
	...
	private boolean isVARNAPanel;

	
	public SwingGraphics(Graphics2D g2d, boolean isVARNAPanel)
	{
	  this.isVARNAPanel = isVARNAPanel;
		_g2d = g2d;
  ...
  public Dimension getStringDimension(String s) {
		...
		return (new Dimension((int) r.getWidth(), fm.getAscent()
				- fm.getDescent()));
	}
