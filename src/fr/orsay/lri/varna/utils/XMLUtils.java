...
public class XMLUtils {
  ...
  public static final String XML_BASELIST_ELEMENT_NAME = "baselist";
  public static final String XML_FONT_ELEMENT_NAME = "font";
  public static final String XML_ROLE_NAME = "role";
  public static final String XML_NAME_NAME = "name";
  public static final String XML_FAMILY_NAME = "family";
  public static final String XML_STYLE_NAME = "style";
  public static final String XML_SIZE_NAME = "size";

  public static void toXML(TransformerHandler hd, Font f, String role)
      throws SAXException {
  ...
  public static Font getFont(String qName, Attributes attributes) {
    if (qName.equals(XMLUtils.XML_FONT_ELEMENT_NAME)) {
      int style = Integer
          .parseInt(attributes.getValue(XMLUtils.XML_STYLE_NAME));
      String name = (attributes.getValue(XMLUtils.XML_NAME_NAME));
      double size = Double
          .parseDouble(attributes.getValue(XMLUtils.XML_SIZE_NAME));
  ...
  public static void toXML(TransformerHandler hd, ModeleBase mb)
      throws SAXException {
  ...
  public static void toXML(TransformerHandler hd, ArrayList<ModeleBase> m)
      throws SAXException {
    AttributesImpl atts = new AttributesImpl();
    String result = "";
    for (ModeleBase mb : m) {
  ...
  public static ArrayList<ModeleBase> toModeleBaseArray(String baselist,
                                                        RNA rna) {
  ...
  public static void exportCDATAElem(TransformerHandler hd, String elem,
                                     String s)
      throws SAXException {
  ...
  public static void exportCDATAString(TransformerHandler hd, String s)
      throws SAXException {
    char[] t = s.toCharArray();
    hd.startCDATA();
    hd.characters(t, 0, t.length);
  ...
  public static boolean getBoolean(Attributes attributes, String attName,
                                   boolean defVal) {
  ...
  public static double getDouble(Attributes attributes, String attName,
                                 double defVal) {
    String val = attributes.getValue(attName);
    if (val != null) {
