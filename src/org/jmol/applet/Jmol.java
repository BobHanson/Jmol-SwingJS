 ...
 * 
 * 
 Jmol Version 15 removes the Java applet
 * 
 * 
...
public class Jmol extends GenericApplet implements WrappedApplet {
  ...
  @Override
  protected String getJmolParameter(String name) {
    // unimplemented
    return null;
  }
  ...
  @Override
  protected void doSendJsTextareaStatus(String strInfo) {
    // unimplemented
  ...
  @Override
  protected void doShowStatus(String errorMsg) {
    // unimplemented
