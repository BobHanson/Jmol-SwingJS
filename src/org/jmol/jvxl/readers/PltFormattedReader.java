...
/*            1         2         3         4         5         6         7
    ...
    -0.41532E+01 0.78468E+01-0.40155E+01 0.79845E+01-0.38912E+01 0.71088E+01
*/
    double xmin = parseDoubleStr(rd().substring(0, 12));
    double xmax = parseDoubleRange(line, 12, 24);
    double ymin = parseDoubleRange(line, 24, 36);
    double ymax = parseDoubleRange(line, 36, 48);
    double zmin = parseDoubleRange(line, 48, 60);
    double zmax = parseDoubleRange(line, 60, 72);
