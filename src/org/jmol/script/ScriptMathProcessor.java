...
public class ScriptMathProcessor {
  ...
  public boolean addXNum(T x) throws ScriptException {
    ...
    if (x instanceof SV) {
      ...
      case T.decimal:
        if (wasX) {
          float f = ((Number) x.value).floatValue();
    ...
    case T.plus:
      ...
      case T.matrix3f:
        ...
        case T.matrix3f:
          ...
          return addXM3(m);
        case T.point3f:
          return addXM4(getMatrix4f((M3d) x1.value, (P3) x2.value));
        }
        break;
      case T.matrix4f:
        switch (x2.tok) {
    ...
    case T.times:
      ...
      case T.matrix3f:
        ...
        if (pt4 != null)
          // q * m --> q
          return addXPt4(
              (Quat.newP4(pt4).mulQ(Quat.newM((M3d) x2.value))).toPoint4f());
        break;
      case T.matrix4f:
        // pt4 * m4
        // [a b c d] * m4
...
//        System.out.println("ScriptMathProc OHOH");
  ...
  public static M4d getMatrix4f(M3d matRotate, T3 vTranslate) {
    return M4d.newMV(matRotate, vTranslate == null ? new V3() : V3.newV(vTranslate));
  }
