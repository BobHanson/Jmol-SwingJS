...
public class CDXMLWriter extends CMLWriter {
  ...
  private void writeNodeProperties(int prop, int len) throws Exception {
    ...
    case kCDXProp_Node_Element: // 0x0402 The atomic number of the atom representing this node. (INT16)
      ...
      break;
    case kCDXProp_Atom_Isotope: // 0x0420 The absolute isotopic mass of an atom (2 for deuterium 14 for carbon-14). (INT16)
  ...
  private int readInt(int len) throws Exception {
    switch (len) {
    case 1:
      return (256 + doc.readByte()) % 256;
    case 2:
      return doc.readShort();
    case 4:
      return doc.readInt();
    case 8:
      return (int) doc.readLong();
    }
  ...
  //General properties.    
  // private final static int kCDXProp_EndObject = 0x0000; // 0x0000 Marks end of object.
  // private final static int kCDXProp_CreationUserName = 0x0001; // 0x0001 The name of the creator (program user's name) of the document. (CDXString)
  // private final static int kCDXProp_CreationDate = 0x0002; // 0x0002 The time of object creation. (CDXDate)
  // private final static int kCDXProp_CreationProgram = 0x0003; // 0x0003 The name of the program including version and platform that created the associated CDX object. ChemDraw 4.0 uses ChemDraw 4.0 as the value of CreationProgram. (CDXString)
  // private final static int kCDXProp_ModificationUserName = 0x0004; // 0x0004 The name of the last modifier (program user's name) of the document. (CDXString)
  // private final static int kCDXProp_ModificationDate = 0x0005; // 0x0005 Time of the last modification. (CDXDate)
  // private final static int kCDXProp_ModificationProgram = 0x0006; // 0x0006 The name of the program including version and platform of the last program to perform a modification. ChemDraw 4.0 uses ChemDraw 4.0 as the value of CreationProgram. (CDXString)
  // private final static int kCDXProp_Unused1 = 0x0007; // 0x0007 Table of contents. (obsolete)
  // private final static int kCDXProp_Name = 0x0008; // 0x0008 Name of an object. (CDXString)
  // private final static int kCDXProp_Comment = 0x0009; // 0x0009 An arbitrary string intended to be meaningful to a user. (CDXString)
  // private final static int kCDXProp_ZOrder = 0x000A; // 0x000A Back-to-front ordering index in 2D drawing. (INT16)
  // private final static int kCDXProp_RegistryNumber = 0x000B; // 0x000B A registry or catalog number of a molecule object. (CDXString)
  // private final static int kCDXProp_RegistryAuthority = 0x000C; // 0x000C A string that specifies the authority which issued a registry or catalog number. Some examples of registry authorities are CAS Beilstein Aldrich and Merck. (CDXString)
  // private final static int kCDXProp_Unused2 = 0x000D; // 0x000D Indicates that this object (the reference object) is an alias to an object elsewhere in the document (the target object). The attributes and contained objects should be taken from the target object. (obsolete)
  // private final static int kCDXProp_RepresentsProperty = 0x000E; // 0x000E Indicates that this object represents some property in some other object. (CDXRepresentsProperty)
  // private final static int kCDXProp_IgnoreWarnings = 0x000F; // 0x000F Signifies whether chemical warnings should be suppressed on this object. (CDXBooleanImplied)
  private final static int kCDXProp_ChemicalWarning = 0x0010; // 0x0010 A warning concerning possible chemical problems with this object. (CDXString)
  // private final static int kCDXProp_Visible = 0x0011; // 0x0011 The object is visible if non-zero. (CDXBoolean)

  //Fonts.   
  // private final static int kCDXProp_FontTable = 0x0100; // 0x0100 A list of fonts used in the document. (CDXFontTable)

  //Coordinates.   
  private final static int kCDXProp_2DPosition = 0x0200; // 0x0200 The 2D location (in the order of vertical and horizontal locations) of an object. (CDXPoint2D)
  // private final static int kCDXProp_3DPosition = 0x0201; // 0x0201 The 3D location (in the order of X- Y- and Z-locations in right-handed coordinate system) of an object in CDX coordinate units. The precise meaning of this attribute varies depending on the type of object. (CDXPoint3D)
  // private final static int kCDXProp_2DExtent = 0x0202; // 0x0202 The width and height of an object in CDX coordinate units. The precise meaning of this attribute varies depending on the type of object. (CDXPoint2D)
  // private final static int kCDXProp_3DExtent = 0x0203; // 0x0203 The width height and depth of an object in CDX coordinate units (right-handed coordinate system). The precise meaning of this attribute varies depending on the type of object. (CDXPoint3D)
  // private final static int kCDXProp_BoundingBox = 0x0204; // 0x0204 The smallest rectangle that encloses the graphical representation of the object. (CDXRectangle)
  // private final static int kCDXProp_RotationAngle = 0x0205; // 0x0205 The angular orientation of an object in degrees * 65536. (INT32)
  // private final static int kCDXProp_BoundsInParent = 0x0206; // 0x0206 The bounds of this object in the coordinate system of its parent (used for pages within tables). (CDXRectangle)
  // private final static int kCDXProp_3DHead = 0x0207; // 0x0207 The 3D location (in the order of X- Y- and Z-locations in right-handed coordinate system) of the head of an object in CDX coordinate units. The precise meaning of this attribute varies depending on the type of object. (CDXPoint3D)
  ...
  // private final static int kCDXProp_TopLeft = 0x0209; // 0x0209 The location of the top-left corner of a quadrilateral object possibly in a rotated or skewed frame. (CDXPoint2D)
  // private final static int kCDXProp_TopRight = 0x020A; // 0x020A The location of the top-right corner of a quadrilateral object possibly in a rotated or skewed frame. (CDXPoint2D)
  // private final static int kCDXProp_BottomRight = 0x020B; // 0x020B The location of the bottom-right corner of a quadrilateral object possibly in a rotated or skewed frame. (CDXPoint2D)
  // private final static int kCDXProp_BottomLeft = 0x020C; // 0x020C The location of the bottom-left corner of a quadrilateral object possibly in a rotated or skewed frame. (CDXPoint2D)

  //Colors.    
  // private final static int kCDXProp_ColorTable = 0x0300; // 0x0300 The color palette used throughout the document. (CDXColorTable)
  // private final static int kCDXProp_ForegroundColor = 0x0301; // 0x0301 The foreground color of an object represented as the two-based index into the object's color table. (UINT16)
  // private final static int kCDXProp_BackgroundColor = 0x0302; // 0x0302 The background color of an object represented as the two-based index into the object's color table. (INT16)

  //Atom properties.   
  private final static int kCDXProp_Node_Type = 0x0400; // 0x0400 The type of a node object. (INT16)
  //   private final static int kCDXProp_Node_LabelDisplay = 0x0401; // 0x0401 The characteristics of node label display. (INT8)
  private final static int kCDXProp_Node_Element = 0x0402; // 0x0402 The atomic number of the atom representing this node. (INT16)
  //   private final static int kCDXProp_Atom_ElementList = 0x0403; // 0x0403 A list of atomic numbers. (CDXElementList)
  //   private final static int kCDXProp_Atom_Formula = 0x0404; // 0x0404 The composition of a node representing a fragment whose composition is known but whose connectivity is not. For example C<sub>4</sub>H<sub>9</sub> represents a mixture of the 4 butyl isomers. (CDXFormula)
  private final static int kCDXProp_Atom_Isotope = 0x0420; // 0x0420 The absolute isotopic mass of an atom (2 for deuterium 14 for carbon-14). (INT16)
  private final static int kCDXProp_Atom_Charge = 0x0421; // 0x0421 The atomic charge of an atom. (INT8)
  //   private final static int kCDXProp_Atom_Radical = 0x0422; // 0x0422 The atomic radical attribute of an atom. (UINT8)
  // private final static int kCDXProp_Atom_RestrictFreeSites = 0x0423; // 0x0423 Indicates that up to the specified number of additional substituents are permitted on this atom. (UINT8)
  // private final static int kCDXProp_Atom_RestrictImplicitHydrogens = 0x0424; // 0x0424 Signifies that implicit hydrogens are not allowed on this atom. (CDXBooleanImplied)
  // private final static int kCDXProp_Atom_RestrictRingBondCount = 0x0425; // 0x0425 The number of ring bonds attached to an atom. (INT8)
  // private final static int kCDXProp_Atom_RestrictUnsaturatedBonds = 0x0426; // 0x0426 Indicates whether unsaturation should be present or absent. (INT8)
  // private final static int kCDXProp_Atom_RestrictRxnChange = 0x0427; // 0x0427 If present signifies that the reaction change of an atom must be as specified. (CDXBooleanImplied)
  // private final static int kCDXProp_Atom_RestrictRxnStereo = 0x0428; // 0x0428 The change of stereochemistry of an atom during a reaction. (INT8)
  // private final static int kCDXProp_Atom_AbnormalValence = 0x0429; // 0x0429 Signifies that an abnormal valence for an atom is permitted. (CDXBooleanImplied)
  // private final static int kCDXProp_Unused3 = 0x042A; // 0x042A 
  // private final static int kCDXProp_Atom_NumHydrogens = 0x042B; // 0x042B The number of (explicit) hydrogens in a labeled atom consisting of one heavy atom and (optionally) the symbol H (e.g. CH<sub>3</sub>). (UINT16)
  ...
  // private final static int kCDXProp_Atom_RestrictSubstituentsUpTo = 0x0435; // 0x0435 Indicates that substitution is restricted to no more than the specified value. (UINT8)
  // private final static int kCDXProp_Atom_RestrictSubstituentsExactly = 0x0436; // 0x0436 Indicates that exactly the specified number of substituents must be present. (UINT8)
  // private final static int kCDXProp_Atom_CIPStereochemistry = 0x0437; // 0x0437 The node's absolute stereochemistry according to the Cahn-Ingold-Prelog system. (INT8)
  // private final static int kCDXProp_Atom_Translation = 0x0438; // 0x0438 Provides for restrictions on whether a given node may match other more- or less-general nodes. (INT8)
  // private final static int kCDXProp_Atom_AtomNumber = 0x0439; // 0x0439 Atom number as text. (CDXString)
  ...
  //Molecule properties.   
  // private final static int kCDXProp_Mole_Racemic = 0x0500; // 0x0500 Indicates that the molecule is a racemic mixture. (CDXBoolean)
  // private final static int kCDXProp_Mole_Absolute = 0x0501; // 0x0501 Indicates that the molecule has known absolute configuration. (CDXBoolean)
  ...
  private final static int kCDXProp_Bond_Display2 = 0x0602; // 0x0602 The display type for the second line of a double bond. (INT16)
  // private final static int kCDXProp_Bond_DoublePosition = 0x0603; // 0x0603 The position of the second line of a double bond. (INT16)
  private final static int kCDXProp_Bond_Begin = 0x0604; // 0x0604 The ID of the CDX node object at the first end of a bond. (CDXObjectID)
  private final static int kCDXProp_Bond_End = 0x0605; // 0x0605 The ID of the CDX node object at the second end of a bond. (CDXObjectID)
  // private final static int kCDXProp_Bond_RestrictTopology = 0x0606; // 0x0606 Indicates the desired topology of a bond in a query. (INT8)
  // private final static int kCDXProp_Bond_RestrictRxnParticipation = 0x0607; // 0x0607 Specifies that a bond is affected by a reaction. (INT8)
  private final static int kCDXProp_Bond_BeginAttach = 0x0608; // 0x0608 Indicates where within the Bond_Begin node a bond is attached. (UINT8)
  ...
  // private final static int kCDXProp_Bond_CIPStereochemistry = 0x060A; // 0x060A The bond's absolute stereochemistry according to the Cahn-Ingold-Prelog system. (INT8)
  // private final static int kCDXProp_Bond_BondOrdering = 0x060B; // 0x060B Ordered list of attached bond IDs. (CDXObjectIDArray)
  // private final static int kCDXProp_Bond_ShowQuery = 0x060C; // 0x060C Show the query indicator if non-zero. (CDXBoolean)
  // private final static int kCDXProp_Bond_ShowStereo = 0x060D; // 0x060D Show the stereochemistry indicator if non-zero. (CDXBoolean)
  // private final static int kCDXProp_Bond_CrossingBonds = 0x060E; // 0x060E Unordered list of IDs of bonds that cross this one (either above or below). (CDXObjectIDArray)
  // private final static int kCDXProp_Bond_ShowRxn = 0x060F; // 0x060F Show the reaction-change indicator if non-zero. (CDXBoolean)

  //Text properties.   
  private final static int kCDXProp_Text = 0x0700; // 0x0700 The text of a text object. (CDXString)
  // private final static int kCDXProp_Justification = 0x0701; // 0x0701 The horizontal justification of a text object. (INT8)
  // private final static int kCDXProp_LineHeight = 0x0702; // 0x0702 The line height of a text object. (UINT16)
  // private final static int kCDXProp_WordWrapWidth = 0x0703; // 0x0703 The word-wrap width of a text object. (INT16)
  // private final static int kCDXProp_LineStarts = 0x0704; // 0x0704 The number of lines of a text object followed by that many values indicating the zero-based text position of each line start. (INT16ListWithCounts)
  // private final static int kCDXProp_LabelAlignment = 0x0705; // 0x0705 The alignment of the text with respect to the node position. (INT8)
  // private final static int kCDXProp_LabelLineHeight = 0x0706; // 0x0706 Text line height for atom labels (INT16)
  // private final static int kCDXProp_CaptionLineHeight = 0x0707; // 0x0707 Text line height for non-atomlabel text objects (INT16)
  // private final static int kCDXProp_InterpretChemically = 0x0708; // 0x0708 Signifies whether to the text label should be interpreted chemically (if possible). (CDXBooleanImplied)

  //Document properties.   
  // private final static int kCDXProp_MacPrintInfo = 0x0800; // 0x0800 The 120 byte Macintosh TPrint data associated with the CDX document object. Refer to Macintosh Toolbox manual for detailed description. (Unformatted)
  // private final static int kCDXProp_WinPrintInfo = 0x0801; // 0x0801 The Windows DEVMODE structure associated with the CDX document object. (Unformatted)
  // private final static int kCDXProp_PrintMargins = 0x0802; // 0x0802 The outer margins of the Document. (CDXRectangle)
  // private final static int kCDXProp_ChainAngle = 0x0803; // 0x0803 The default chain angle setting in degrees * 65536. (INT32)
  // private final static int kCDXProp_BondSpacing = 0x0804; // 0x0804 The spacing between segments of a multiple bond measured relative to bond length. (INT16)
  // private final static int kCDXProp_BondLength = 0x0805; // 0x0805 The default bond length. (CDXCoordinate)
  // private final static int kCDXProp_BoldWidth = 0x0806; // 0x0806 The default bold bond width. (CDXCoordinate)
  // private final static int kCDXProp_LineWidth = 0x0807; // 0x0807 The default line width. (CDXCoordinate)
  // private final static int kCDXProp_MarginWidth = 0x0808; // 0x0808 The default amount of space surrounding atom labels. (CDXCoordinate)
  // private final static int kCDXProp_HashSpacing = 0x0809; // 0x0809 The default spacing between hashed lines used in wedged hashed bonds. (CDXCoordinate)
  // private final static int kCDXProp_LabelStyle = 0x080A; // 0x080A The default style for atom labels. (CDXFontStyle)
  // private final static int kCDXProp_CaptionStyle = 0x080B; // 0x080B The default style for non-atomlabel text objects. (CDXFontStyle)
  // private final static int kCDXProp_CaptionJustification = 0x080C; // 0x080C The horizontal justification of a caption (non-atomlabel text object) (INT8)
  // private final static int kCDXProp_FractionalWidths = 0x080D; // 0x080D Signifies whether to use fractional width information when drawing text. (CDXBooleanImplied)
  // private final static int kCDXProp_Magnification = 0x080E; // 0x080E The view magnification factor (INT16)
  // private final static int kCDXProp_WidthPages = 0x080F; // 0x080F The width of the document in pages. (INT16)
  // private final static int kCDXProp_HeightPages = 0x0810; // 0x0810 The height of the document in pages. (INT16)
  // private final static int kCDXProp_DrawingSpaceType = 0x0811; // 0x0811 The type of drawing space used for this document. (INT8)
  // private final static int kCDXProp_Width = 0x0812; // 0x0812 The width of an object in CDX coordinate units possibly in a rotated or skewed frame. (CDXCoordinate)
  // private final static int kCDXProp_Height = 0x0813; // 0x0813 The height of an object in CDX coordinate units possibly in a rotated or skewed frame. (CDXCoordinate)
  // private final static int kCDXProp_PageOverlap = 0x0814; // 0x0814 The amount of overlap of pages when a poster is tiled. (CDXCoordinate)
  // private final static int kCDXProp_Header = 0x0815; // 0x0815 The text of the header. (CDXString)
  // private final static int kCDXProp_HeaderPosition = 0x0816; // 0x0816 The vertical offset of the header baseline from the top of the page. (CDXCoordinate)
  // private final static int kCDXProp_Footer = 0x0817; // 0x0817 The text of the footer. (CDXString)
  // private final static int kCDXProp_FooterPosition = 0x0818; // 0x0818 The vertical offset of the footer baseline from the bottom of the page. (CDXCoordinate)
  // private final static int kCDXProp_PrintTrimMarks = 0x0819; // 0x0819 If present trim marks are to printed in the margins. (CDXBooleanImplied)
  // private final static int kCDXProp_LabelStyleFont = 0x081A; // 0x081A The default font family for atom labels. (INT16)
  // private final static int kCDXProp_CaptionStyleFont = 0x081B; // 0x081B The default font style for captions (non-atom-label text objects). (INT16)
  // private final static int kCDXProp_LabelStyleSize = 0x081C; // 0x081C The default font size for atom labels. (INT16)
  // private final static int kCDXProp_CaptionStyleSize = 0x081D; // 0x081D The default font size for captions (non-atom-label text objects). (INT16)
  // private final static int kCDXProp_LabelStyleFace = 0x081E; // 0x081E The default font style for atom labels. (INT16)
  // private final static int kCDXProp_CaptionStyleFace = 0x081F; // 0x081F The default font face for captions (non-atom-label text objects). (INT16)
  // private final static int kCDXProp_LabelStyleColor = 0x0820; // 0x0820 The default color for atom labels (INT16)
  // private final static int kCDXProp_CaptionStyleColor = 0x0821; // 0x0821 The default color for captions (non-atom-label text objects). (INT16)
  // private final static int kCDXProp_BondSpacingAbs = 0x0822; // 0x0822 The absolute distance between segments of a multiple bond. (CDXCoordinate)
  // private final static int kCDXProp_LabelJustification = 0x0823; // 0x0823 The default justification for atom labels. (INT8)
  // private final static int kCDXProp_FixInplaceExtent = 0x0824; // 0x0824 Defines a size for OLE In-Place editing. (CDXPoint2D)
  // private final static int kCDXProp_Side = 0x0825; // 0x0825 A specific side of an object (rectangle). (INT16)
  // private final static int kCDXProp_FixInplaceGap = 0x0826; // 0x0826 Defines a padding for OLE In-Place editing. (CDXPoint2D)

  //Graphic object properties.   
  // private final static int kCDXProp_Graphic_Type = 0x0A00; // 0x0A00 The type of graphical object. (INT16)
  // private final static int kCDXProp_Line_Type = 0x0A01; // 0x0A01 The type of a line object. (INT16)
  // private final static int kCDXProp_Arrow_Type = 0x0A02; // 0x0A02 The type of arrow object which represents line arrow arc rectangle or orbital. (INT16)
  // private final static int kCDXProp_Rectangle_Type = 0x0A03; // 0x0A03 The type of a rectangle object. (INT16)
  // private final static int kCDXProp_Oval_Type = 0x0A04; // 0x0A04 The type of an arrow object that represents a circle or ellipse. (INT16)
  // private final static int kCDXProp_Orbital_Type = 0x0A05; // 0x0A05 The type of orbital object. (INT16)
  // private final static int kCDXProp_Bracket_Type = 0x0A06; // 0x0A06 The type of symbol object. (INT16)
  // private final static int kCDXProp_Symbol_Type = 0x0A07; // 0x0A07 The type of symbol object. (INT16)
  // private final static int kCDXProp_Curve_Type = 0x0A08; // 0x0A08 The type of curve object. (INT16)
  // private final static int kCDXProp_Arrow_HeadSize = 0x0A20; // 0x0A20 The size of the arrow's head. (INT16)
  ...
  // private final static int kCDXBondOrder_SingleOrDouble = kCDXBondOrder_Single | kCDXBondOrder_Double   
  // private final static int kCDXBondOrder_SingleOrAromatic = kCDXBondOrder_Single | kCDXBondOrder_OneHalf    
  // private final static int kCDXBondOrder_DoubleOrAromatic = kCDXBondOrder_Double | kCDXBondOrder_OneHalf    
