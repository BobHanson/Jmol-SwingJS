...
public class ModelKitPopupResourceBundle extends PopupResource {
  ...
  private static String[][] menuContents = {
    ...
    { "moreAtomMenu", "clearQPersists - _??P!RD _??P!RD _??P!RD _??P!RD _??P!RD _??P!RD " },
    ...
    { "xtalMenu", "xtalModePersistsMenu xtalSelPersistsMenu xtalSelOpPersistsMenu xtalSymmetryPersistsMenu xtalPackingPersistsMenu xtalOptionsPersistsMenu" },
    { "xtalModePersistsMenu", "mkmode_molecular mkmode_view mkmode_edit" }, 
    { "xtalSelPersistsMenu", "mksel_atom mksel_position" },
    { "xtalSelOpPersistsMenu", "xtalOpPersistsMenu mkselop_addOffset mkselop_atom2" },
    { "xtalSymmetryPersistsMenu", "mksymmetry_none mksymmetry_retainLocal mksymmetry_applyLocal mksymmetry_applyFull" },
    { "xtalPackingPersistsMenu", "mkunitcell_extend mkunitcell_packed" },
    { "xtalOptionsPersistsMenu", "mkaddHydrogens??P!CB mkclicktosetelement??P!CB" }
  ...
  protected String[] getWordContents() {
    ...
    String[] words = new String[] {
        ...
        "xtalMenu", "<xtal.png>",
        "xtalModePersistsMenu","mode",
        "xtalSelPersistsMenu","select atom or position",
        "xtalSelOpPersistsMenu","select operator", 
        "xtalOpPersistsMenu","from list...", 
        "xtalSymmetryPersistsMenu", "symmetry",
        "xtalOptionsPersistsMenu", "options",
        "xtalPackingPersistsMenu", "packing",
