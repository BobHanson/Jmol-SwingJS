...
public class Jvxl {
  ...
  static P4d getPlane(String str) {
    ...
    if (str.indexOf("x=") == 0) {
      return P4d.new4(1, 0, 0, -PT.parseFloat(str.substring(2)));
    }
    if (str.indexOf("y=") == 0) {
      return P4d.new4(0, 1, 0, -PT.parseFloat(str.substring(2)));
    }
    if (str.indexOf("z=") == 0) {
      return P4d.new4(0, 0, 1, -PT.parseFloat(str.substring(2)));
    }
    if (str.indexOf("{") == 0) {
      str = str.replace(',', ' ');
      int[] next = new int[1];
